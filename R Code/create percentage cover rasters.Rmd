...
# open the selected sample file
  ...
  writeRaster(r_filt, paste0("/ascii files",filename, radius), overwrite=TRUE)
    cat("\n","Saved",paste0(filename,radius),"in",paste0(getwd(),"/ascii files"),"\n","\n")
  }
```

```{r run_ghm_analysis}
  setwd("C:/Users/awhitehead/Documents/GIS_data/Hunter/vegetation/GHM raster data")
...
# create a sampling mask
  ...
  hcr_mask <- readGDAL("C:/Users/awhitehead/Documents/GIS_data/Hunter/environment/environment clipped by cma/hcr_mask")
