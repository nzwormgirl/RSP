...
GH.mask <- raster("~/GIS_data/Hunter/mask files/GH.mask.tif")
  ...
  LH.urban.clipping.mask <- raster("~/GIS_data/Hunter/mask files/LH.urban.clipping.mask.tif")
...
# UH mining shape
  UH.mine.shp <- readShapePoly("~/GIS_data/Hunter/All data from harddrive/From HCCREMS/Boundaries/AoI/Rough_UH_AoIv2.shp")
...
writeRaster(GH.coal.prob.scaled,paste0("~/GIS_data/Hunter/Scenarios/coal data/GH.coalforChris.tif"),format="GTiff",overwrite=T)
writeRaster(LH.coal.prob.scaled,paste0("~/GIS_data/Hunter/zonation/lower hunter/coal tifs/mining_100_LHcoal.tif"),format="GTiff",overwrite=T)
writeRaster(UH.coal.prob.scaled,paste0("~/GIS_data/Hunter/zonation/upper hunter/coal tifs/mining_100_UHcoal.tif"),format="GTiff",overwrite=T)

# LH.coal.prob.scaled.clip <- mask(LH.coal.prob.scaled,LH.urban.clipping.mask,filename=paste0("~/GIS_data/Hunter/zonation/lower hunter/coal tifs/mining_100_LHcoal.clipped.tif"),format="GTiff",overwrite=T)
...
pdf("~/GIS_data/Hunter/Scenarios/coal data/Potential coal scenarios.pdf",paper="a4r",width=0,height=0)
...
for(i in seq(prob.range)){
  ...
  r <- merge(r,GH.mask,filename=paste0("~/GIS_data/Hunter/Scenarios/coal data/mining_",prob.range[i],"_GHcoal.tif"),format="GTiff",overwrite=T)
  
#   r <- mask(r,LH.urban.clipping.mask,filename=paste0("~/GIS_data/Hunter/zonation/lower hunter/coal tifs/mining_",prob.range[i],"_LHcoal.clipped.tif"),format="GTiff",overwrite=T)
...
for(i in seq(prob.range)){
  ...
  r <- merge(r,LH.mask,filename=paste0("~/GIS_data/Hunter/zonation/lower hunter/coal tifs/mining_",prob.range[i],"_LHcoal.tif"),format="GTiff",overwrite=T)
...
for(i in seq(prob.range)){
  ...
  r <- merge(r,UH.mask,filename=paste0("~/GIS_data/Hunter/zonation/upper hunter/coal tifs/mining_",prob.range[i],"_UHcoal.tif"),format="GTiff",overwrite=T)
  
  r <- mask(r,UH.clipping.mask,filename=paste0("~/GIS_data/Hunter/zonation/upper hunter/coal tifs/mining_",prob.range[i],"_UHcoal.clipped.tif"),format="GTiff",overwrite=T)

  png(paste0("~/GIS_data/Hunter/zonation/upper hunter/coal tifs/mining_",prob.range[i],"_UHcoal.clipped.png"),height=15,width=15,units="cm",res=300,pointsize=12)
