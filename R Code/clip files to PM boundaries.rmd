...
PMHC.ignore <- read.csv(paste0(PM.zonation.dir,"output/PM_new.species.csv"))
  ...
  PMHC.ignore <- append(PMHC.ignore,c("Eudyptula_minor","Morus_serrator",setdiff(protected.species$Scientific.Name[protected.species$Taxa=="plants"],included.plants$ScientificName)))
