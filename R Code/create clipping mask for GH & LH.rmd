...
# Lakes
  lakes <- readShapePoly("~/GIS_data/Hunter/All data from harddrive/Lakes/Lakes.shp",proj4string=CRS("+proj=utm +zone=56 +south +ellps=aust_SA +units=m +no_defs"))
...
# create Hunter Valley (7 LGA) mask
  HV.mask <- crop(rasterize(HV.shp,GH.mask,value=1),HV.shp, filename="~/GIS_data/Hunter/mask files/HV.mask.tif",format="GTiff",overwrite=T)

# create Port Macquarie mask
 PM.shp <- readShapePoly("~/GIS_data/Hunter/All data from harddrive/Port MacQuarie/PMHC LGA boundary.shp")
...
writeRaster(LH.lakes.mask,"//654cw-20990/Amy/GIS_data/Hunter/mask files/LH.lakes.mask.tif",format="GTiff",overwrite=T)

LH.exurban.mask <- min(LH.exurban.mask,LH.lakes.mask)

  writeRaster(LH.exurban.mask,"//654cw-20990/Amy/GIS_data/Hunter/mask files/LH.urban.clipping.mask.tif",format="GTiff",overwrite=T)
...
# HV clipping mask
HV.veg <- mask(crop(GH.veg,HV.mask),HV.mask,filename="~/GIS_data/Hunter/mask files/HV.clipping.mask.tif",format="GTiff",overwrite=T)

# PM clipping mask
PM.veg <- mask(crop(GH_PM.veg,PM.mask),PM.mask,filename=paste0(computer,"/GIS_data/Hunter/mask files/PM.clipping.mask.tif"),format="GTiff",overwrite=T)

```

```{r wyong}
# wyong clipping mask
wyong.mask <- raster("~/GIS_data/Hunter/mask files/wyong.mask.tif")
wyong.veg <- readShapePoly("~/GIS_data/Hunter/vegetation/Vegetation2008_WSC_20140716.shp",proj4string=GDA94.56)
...
# Tetratheca juncea
  tet.jun <- readShapePoints("//654cw-20990/Amy/GIS_data/Wyong/Wyong Shire Council Data/Species/Tetratheca_juncea_WSC_20140716.shp",proj4string=GDA94.56)
...
# Corunastylis_charmhaven
  cor.cha <- readShapePoly("//654cw-20990/Amy/GIS_data/Wyong/Wyong Shire Council Data/Species/Corunastylis_charmhaven_WSC_20140804.shp",proj4string=GDA94.56)
...
# Corunastylis_insignis
  cor.ins <- readShapePoly("//654cw-20990/Amy/GIS_data/Wyong/Wyong Shire Council Data/Species/Corunastylis_insignis_WSC_20140804.shp",proj4string=GDA94.56)
...
# Thelymitra adorata
  the.ado <- readShapePoly("//654cw-20990/Amy/GIS_data/Wyong/Wyong Shire Council Data/Species/Thelymitra_adorata_WSC_20140804.shp",proj4string=GDA94.56)
