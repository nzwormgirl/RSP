...
# set output options
  ...
  shutdown <- TRUE # shutdown computer when the script is finished
...
species.list <- threatened.species$Scientific.Name[rowSums(threatened.species[,c("ALA.records","NSW.records")],na.rm=TRUE) > 0]
