...
if(include.brut == TRUE) {
    gda_ssi.zonation.data <- rbind(brut.ssi.zonation.data[,c("species","longitude","latitude")], atlas.ssi.zonation.data[,c("species","longitude","latitude","database")])
    } else gda_ssi.zonation.data <- ssi.zonation.data[,c("species","longitude","latitude","database")]
