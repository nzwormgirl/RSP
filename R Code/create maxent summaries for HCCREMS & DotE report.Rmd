...
>>>>>>> 1d6045cd5fbbf9af37fc48905584bdb0fc35cd3c
...
<<<<<<< HEAD
  GH.shp <- readShapePoly("G:/UM backup/GIS_data/Hunter/Plans/HCCREMS_AreaOfInterest/HCCREMS_AoI.shp", proj4=GDA94)
=======
...
write.csv(output,paste0(maxent.dir,"GH DotE report - maxent summary.v3_PMHC.csv"),row.names=F)

poorly.modelled <- output[output$Test.AUC<0.7,c("Taxa","Species","Status","MNES","N.records","Test.AUC","AUC.Standard.Deviation")]
write.csv(poorly.modelled,paste0(maxent.dir,"DotE report - poorly modelled species.v3_PMHC.csv"),row.names=F)
```
...
write.csv(summary.table,paste0(maxent.dir,"GH DotE report - maxent parameter summary.v3_PMHC.csv"),row.names=T)
