...
write.csv(summary.table,paste0(maxent.dir,"DotE report - maxent parameter summary.csv"),row.names=T)
...
png(paste0(maxent.dir,"AUC_boxplot.png"),width=15,height=15,units = "cm",pointsize=12,bg="transparent",res=300)
