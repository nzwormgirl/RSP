...
packages(rgeos)
  ...
  zonation.dir <- c("~/GIS_data/Hunter/zonation/lower hunter/")
...
convert.to.tif <- function (r, rescale=1) {
  ...
  writeRaster(r,paste0(zonation.dir,species,"_LH.tif"), overwrite=T, format="GTiff")
  return(r)
...
rh <- raster("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/SPRH/data/LHPP_SPWA&REHO_project_data/REHO Maxent/Regent_Honeyeater.asc")
...
```{r swift parrot}
  swp <- raster("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/SPRH/data/LHPP_SPWA&REHO_project_data/SWPA Maxent/Swift_Parrot.asc")
  swp[is.na(swp)] <- 0
...
```{r koala}
 koala <- raster("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/Koala/data/commondata/data1/rawhabval6")
  koala[is.na(koala)] <- 0
...
ghff_foraging <- readShapePoly("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/GHFF/data/ForagingRanks_Eby_GeoLINK_08012013.shp", proj4=GDA94.56)
...
## convert ghff roosting habitat camps to raster
  ghff_roosting <- readShapePoints("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/GHFF/data/LH_GHFFcamps_GeoLINK_Eby_05042013.shp", proj4=GDA94.56)
...
create.raster <- function (s, mask.raster, raster.label, value=1, transform=FALSE) {
  ...
  r <- rasterize(s,mask.raster)
    r[!is.na(r)] <- value
    r <- mask(merge(r,mask.raster),mask.raster, filename=paste0(zonation.dir,raster.label), format="GTiff", overwrite=T)
...
saltmarsh <- readShapePoly("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/EC/data/LH_Nominated_EC_Saltmarsh.shp", proj4=GDA94)
...
hinterland <- readShapePoly("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/EC/data/LH_Nominated_EC_Hinterland.shp", proj4=GDA94)
...
lowland <- readShapePoly("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/EC/data/LH_Nominated_EC_Lowland.shp", proj4=GDA94)
...
littoral <- readShapePoly("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/EC/data/LH_Nominated_EC_Littoral.shp", proj4=GDA94)
...
remnant <- readShapePoly("~/GIS_data/Hunter/All data from harddrive/From DO/LH_DoE_research/SEWPAC/EC/data/LH_Nominated_EC_Remnant.shp", proj4=GDA94)
