...
# LH administrative boundary
  LH.shp <- readShapePoly(paste0(computer,"/GIS_data/Hunter/mask files/5_LGAs_StudyArea.shp"), proj4=GDA94.56)
...
write.csv(pa.top.table,paste0(output_path,"protected megatable for LH report_040215.csv"),row.names=F)
...
write.csv(dev.impacts,paste0(output_path,"development megatable for LH report_040215.csv"),row.names=F)
