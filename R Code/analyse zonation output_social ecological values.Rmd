...
tiff("figures for ms/overlay_thresholds.tif",res=200,width=15,height=10,units="cm",pointsize=12, compression="lzw")
...
tiff(filename="replacement.cost.curves.tif",width=15,height=20,units="cm",pointsize=12,res=200,compression="lzw")
...
tiff(filename="replacement.cost.curves_supplementary.tif",width=15,height=20,units="cm",pointsize=12,res=200,compression="lzw")
